...
def adjust_brightness_contrast(image: ImageArray, brightness: int = 0, contrast: float = 1.0) -> ImageArray:
...
def adjust_color_balance(image: ImageArray, red: int = 0, green: int = 0, blue: int = 0) -> ImageArray:
